...
The standard deviation when team size is \textbf{not} taken into account is 0.2 and the median is 0.5. The median when team size is taken into account is 0.2, while the standard deviation is increased by 0.1. The median numbers shows significant impact of team size between the relationship of \textbf{WIP} and \textbf{bug}. The std.dev value shows a minor variation between the two results variables.  Shown in \ref{DS:corr:WIP} and \ref{DS:corr:WIP:v2}     
