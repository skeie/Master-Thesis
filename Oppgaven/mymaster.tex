...
\vspace{-1em}
As stated in Section \ref{sec:in:lt}, lead time could be used to track how quickly software is delivered to customers. Each development process would like to get their lead time as low as possible. In Section \ref{WIPsec} there is stated that WIP-limits are important to reduce lead times. The correlation between \textit{lead time} and \textit{WIP} shows a mean correlation of 0.2, shown by Table \ref{DS:corr:WIP:v2}. This means that in average \textit{throughput} increases when \textit{WIP} increases. The teams \textbf{two, four} and \textbf{seven} have a significant correlation of 0.67, 0.87 and 0.77. These three teams have a mean WIP-limit of 2.31, 3.21 and 2. Teams \textbf{one, eight} and \textbf{nine} have negative correlation of -0.09, -0.09 and -0.18. These teams have a mean WIP-limit of 0.73, 1.09 and 2.19.

The mean lead time for teams \textbf{one, eight} and \textbf{nine} are 0.93, 1.9 and 2.06. The teams \textbf{two, four} and \textbf{seven} have mean lead time of 1.3, 2.25 and 1.87
