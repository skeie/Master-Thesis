...
The first correlation result showed a medium-high correlation relationship between team size and both \textit{WIP} and \textit{throughput}. Based on the correlation values, it's was hard to find any evidence if WIP limit matter in software development. This resulted in a new analyze where each variable for each quarter was divided by their team size. 
 ...
 Each of the sections are presented with five correlation tables and five corresponding descriptive statistics tables.
...
\section{Results without team size}
\subsection{Correlation - WIP}
\label{sec:corr:WIP}
...
\subsection{Correlation - Lead time}
\label{sec:corr:lt}
...
\subsection {Correlation - Throughput}
\label{sec:corr:TP}
...
\end{tabular}
 ...
 \subsection{Correlation - Team size}
...
\section{Result divide by team size}
As shown by Table \ref{DS:corr:TS}, most the data has a close relationship to team size, which is makes sense. To try to remove bias, each of eleven variables were divided by their team size. The mean value for each variables per quarter were divided by the team size of the same quarter.

\subsection{Correlation - Throughput - divide per team size}
\begin{table}[!htbp]
  \begin{adjustwidth}{-1.5cm}{}
 \centering
 \begin{tabular}{|l|r|r|r|r|r|r|r|r|r|r|}
\hline
 ...
 WIP  & 0.37 & 0.59* & 0.57* & 0.86** & 0.11 & 0.08 & 0.49 & 0.28 & 0.53 & -0.21 \\ \hline
 Throughput Feature  & 0.71** & 0.72** & 0.90** & 1** & 0.40 & 0.98** & 0.90** & -0.02 & 0.67** & -0.11 \\ \hline
 Throughput bug  & 0.16 & 0.98** & 0.98** & 1** & 0.99** & 0.31 & 0.56 & 0.82** & 0.65* & 1**\\ \hline
 Bugs  & 0.05 & 0.90** & 0.81** & 0.32 & 0.97** & -0.02 & 0.46 & 0.82** & 0.70** & 0.96** \\ \hline
 Bugs finished, quarter  & -0.11 & 0.69** & 0.04 & 0.56* & 0.57* & 0.07 & 0.31 & 0.71** & -0.52 & 0.67** \\ \hline
 Avg days in backlog, bugs  & 0.02 & -0.33 & 0.44 & -0.12 & 0.80** & -0.35 & -0.06 & 0.09 & 0.55* & 0.27 \\ \hline
 Leadtime  & 0.06 & 0.88** & 0.26 & 0.90** & 0.80** & 0.69** & 0.33 & 0.24 & -0.36 & 0.90** \\ \hline
 Churn  & -0.14 & 0.37 & 0.23 & 0.88** & 0.79** & -0.28 & 0.46 & 0.75** & -0.54* & 0.06 \\ \hline
 Churn feature  & 0.05 & 0.20 & 0.18 & 0.90** & -0.11 & -0.16 & 0.12 & 0.18 & -0.24 & -0.35 \\ \hline
 Churn bug  & -0.17 & 0.47 & 0.14 & 0.18 & 0.80** & -0.17 & 0.01 & 0.70** & 0.05 & 0.11 \\ \hline
\end{tabular}
 \caption{Correlation - Throughput}
 \label{corr:TP:V}
 \centerline {* Correlation is significant at the 0.05 level (2-tailed).}
...
Throughput ft  & 10 & 0.6 & 0.7 & 0.4 & 1 & -0.1\\ \hline
Throughput bug  & 10 & 0.7 & 0.9 & 0.3 & 1 & 0.2\\ \hline
Bugs  & 10 & 0.6 & 0.8 & 0.4 & 1 & -0\\ \hline
Bugs finished, quarter  & 10 & 0.3 & 0.4 & 0.4 & 0.7 & -0.5\\ \hline
Avg days backlog, bugs  & 10 & 0.1 & 0.1 & 0.4 & 0.8 & -0.3\\ \hline
Lead time & 10 & 0.5 & 0.5 & 0.4 & 0.9 & -0.4\\ \hline
Churn  & 10 & 0.3 & 0.3 & 0.5 & 0.9 & -0.5\\ \hline
Churn ft  & 10 & 0.1 & 0.1 & 0.3 & 0.9 & -0.3\\ \hline
...
\subsection{Bugs - correlation - divide per team size}
\FloatBarrier
\begin{table}[H]
  \begin{adjustwidth}{-2.5cm}{}
 \centering
...
\hline
 &  \bf{T1} & \bf{T2} & \bf{T3} & \bf{T4} & \bf{T5} & \bf{T6} & \bf{T7} & \bf{T8} & \bf{T9} & \bf{T10}\\ \hline
 WIP  & 0.10 & 0.49 & 0.25 & 0.27 & 0.11 & 0.25 & 0.75* & 0.32 & 0.22 & -0.28 \\ \hline
 Throughput  & 0.05 & 0.90** & 0.81** & 0.32 & 0.97** & -0.02 & 0.46 & 0.82** & 0.70** & 0.96** \\ \hline
 Throughput Feature  & -0.12 & 0.62* & 0.66** & 0.33 & 0.50 & -0.10 & 0.48 & -0.52 & 0.90** & -0.25 \\ \hline
 Throughput bug  & 0.79** & 0.92** & 0.79** & 0.33 & 0.95** & 0.80** & 0.60 & 0.98** & 0.70** & 0.96** \\ \hline
 Bugs finished, quarter  & 0.59* & 0.50 & 0.44 & 0.17 & 0.52 & 0.77** & 0.86** & 0.70** & -0.57* & 0.59* \\ \hline
 Avg days in backlog, bugs  & 0.76** & -0.07 & 0.38 & 0.18 & 0.75** & 0.30 & 0.37 & 0.38 & 0.66* & 0.39 \\ \hline
 Leadtime  & 0.83** & 0.72** & 0.48 & 0.22 & 0.72** & 0.18 & 0.85** & -0.23 & -0.09 & 0.88** \\ \hline
 Churn  & 0.47 & 0.29 & 0.67** & 0.22 & 0.73** & 0.20 & -0.05 & 0.34 & -0.46 & 0.19 \\ \hline
 Churn feature  & -0.40 & 0.12 & 0.62* & 0.27 & -0.10 & 0.27 & -0.07 & -0.26 & -0.03 & -0.19 \\ \hline
 Churn bug  & 0.48 & 0.35 & 0.55* & 0.44 & 0.73** & -0.19 & -0.08 & 0.78** & 0.05 & 0.23 \\ \hline
...
Throughput  & 10 & 0.6 & 0.8 & 0.4 & 1 & -0\\ \hline
Throughput ft  & 10 & 0.2 & 0.4 & 0.5 & 0.9 & -0.5\\ \hline
Throughput bug  & 10 & 0.8 & 0.8 & 0.2 & 1 & 0.3\\ \hline
Bugs finished, quarter  & 10 & 0.5 & 0.6 & 0.4 & 0.9 & -0.6\\ \hline
Avg days backlog, bugs  & 10 & 0.4 & 0.4 & 0.3 & 0.8 & -0.1\\ \hline
Lead time & 10 & 0.5 & 0.6 & 0.4 & 0.9 & -0.2\\ \hline
Churn  & 10 & 0.3 & 0.3 & 0.3 & 0.7 & -0.5\\ \hline
Churn ft  & 10 & 0 & -0.1 & 0.3 & 0.6 & -0.4\\ \hline
Churn bug  & 10 & 0.3 & 0.4 & 0.3 & 0.8 & -0.2 \\ \hline
...
\subsection{Lead time - correlation - divide per team size}
\begin{table}[H]
  \begin{adjustwidth}{-2.5cm}{}
 \centering
 \begin{tabular}{|l|r|r|r|r|r|r|r|r|r|r|}
...
\begin{table}[H]
 ...
 \hline
& \bf{N} & \bf{Mean} & \bf{Median} & \bf{Std.Dev} & \bf{Max} & \bf{Min} \\ \hline
WIP  & 10 & 0.2 & 0 & 0.4 & 0.9 & -0.3\\ \hline
Throughput  & 10 & 0.5 & 0.5 & 0.4 & 0.9 & -0.4\\ \hline
Throughput ft  & 10 & 0.3 & 0.2 & 0.5 & 0.9 & -0.3\\ \hline
...
Avg days backlog, bugs  & 10 & 0 & -0.1 & 0.4 & 0.8 & -0.6\\ \hline
Churn  & 10 & 0.4 & 0.3 & 0.4 & 1 & -0\\ \hline
Churn ft  & 10 & 0.2 & 0.2 & 0.5 & 1 & -0.5\\ \hline
...
\subsection{WIP - correlation - divide per team size}
\begin{table}[H]
  \begin{adjustwidth}{-1.5cm}{}
 \centering
 \begin{tabular}{|l|r|r|r|r|r|r|r|r|r|r|}
\hline
 &  \bf{T1} & \bf{T2} & \bf{T3} & \bf{T4} & \bf{T5} & \bf{T6} & \bf{T7} & \bf{T8} & \bf{T9} & \bf{T10}\\ \hline
 Throughput  & 0.37 & 0.59* & 0.57* & 0.86** & 0.11 & 0.08 & 0.49 & 0.28 & 0.53 & -0.21 \\ \hline
 Throughput Feature  & 0.31 & 0.47 & 0.71** & 0.85** & 0 &0.14 & 0.46 & -0.26 & 0.01 & -0.16 \\ \hline
 Throughput bug  & 0.09 & 0.65* & 0.52 & 0.85** & 0.11 & 0.07 & 0.57 & 0.37 & 0.19 & -0.22 \\ \hline
 Bugs  & 0.10 & 0.49 & 0.25 & 0.27 & 0.11 & 0.25 & 0.75* & 0.32 & 0.22 & -0.28 \\ \hline
 Bugs finished, quarter  & -0.28 & 0.71** & -0.62* & 0.74** & -0.24 & -0.04 & 0.85** & 0.82** & -0.75** & -0.28 \\ \hline
 Avg days in backlog, bugs  & 0.03 & -0.31 & 0.51 & 0.10 & -0.14 & 0 &0.16 & -0.17 & 0.43 & -0.61* \\ \hline
 Leadtime  & -0.09 & 0.67** & -0.03 & 0.87** & 0.03 & 0.32 & 0.77* & -0.09 & -0.28 & -0.05 \\ \hline
 Churn  & -0.27 & 0.16 & -0.29 & 0.77** & -0.09 & -0.35 & -0.17 & 0.39 & -0.80** & -0.37 \\ \hline
 Churn feature  & 0.37 & 0.03 & -0.38 & 0.78** & -0.15 & -0.39 & -0.17 & -0.04 & -0.24 & 0.08 \\ \hline
 Churn bug  & -0.29 & 0.21 & -0.39 & 0.26 & -0.07 & 0.12 & -0.17 & 0.66* & 0.05 & -0.43 \\ \hline
\end{tabular}
 \caption{Correlation - WIP}
 \label{corr:WIP:V2}
 \centerline {* Correlation is significant at the 0.05 level (2-tailed).}
...
Throughput ft  & 10 & 0.3 & 0.2 & 0.4 & 0.9 & -0.3\\ \hline
Throughput bug  & 10 & 0.3 & 0.3 & 0.3 & 0.9 & -0.2\\ \hline
Bugs  & 10 & 0.2 & 0.2 & 0.3 & 0.8 & -0.3\\ \hline
Bugs finished, quarter  & 10 & 0.1 & -0.1 & 0.6 & 0.8 & -0.8\\ \hline
Avg days backlog, bugs  & 10 & 0 & 0 & 0.3 & 0.5 & -0.6\\ \hline
Lead time & 10 & 0.2 & 0 & 0.4 & 0.9 & -0.3\\ \hline
Churn  & 10 & -0.1 & -0.2 & 0.4 & 0.8 & -0.8\\ \hline
Churn ft  & 10 & 0 & -0.1 & 0.4 & 0.8 & -0.4\\ \hline
Churn bug  & 10 & 0 & 0 & 0.3 & 0.7 & -0.4 \\ \hline
\end{tabular}
 \caption{Descriptive Statistic - Correlation - WIP}
...
\subsection{Churn - correlation - divide per teams}
\begin{table}[H]
\begin{adjustwidth}{-1.5cm}{}
 \centering
 \begin{tabular}{|l|r|r|r|r|r|r|r|r|r|r|}
\hline
 &  \bf{T1} & \bf{T2} & \bf{T3} & \bf{T4} & \bf{T5} & \bf{T6} & \bf{T7} & \bf{T8} & \bf{T9} & \bf{T10}\\ \hline
 WIP  & -0.27 & 0.16 & -0.29 & 0.77** & -0.09 & -0.35 & -0.17 & 0.39 & -0.80** & -0.37 \\ \hline
 Throughput  & -0.14 & 0.37 & 0.23 & 0.88** & 0.79** & -0.28 & 0.46 & 0.75** & -0.54* & 0.06 \\ \hline
 Throughput Feature  & -0.39 & 0.68** & 0.11 & 0.87** & -0.02 & -0.39 & 0.56 & 0.48 & -0.11 & 0.08 \\ \hline
 Throughput bug  & -0.03 & 0.30 & 0.20 & 0.87** & 0.83** & 0.28 & 0.08 & 0.34 & -0.23 & 0.07 \\ \hline
 Bugs  & 0.47 & 0.29 & 0.67** & 0.22 & 0.73** & 0.20 & -0.05 & 0.34 & -0.46 & 0.19 \\ \hline
 Bugs finished, quarter  & 0.95** & 0.68** & 0.76** & 0.34 & 0.90** & 0.33 & -0.16 & 0.61* & 0.93** & 0.44 \\ \hline
 Avg days in backlog, bugs  & -0.11 & -0.55* & 0.15 & -0.12 & 0.88** & 0.56* & 0.39 & -0.18 & -0.52 & 0.76** \\ \hline
 Leadtime  & 0.72** & 0.49 & 0.16 & 0.96** & 0.94** & 0.04 & 0.08 & 0.71** & -0.02 & 0.01 \\ \hline
 Churn feature  & -0.40 & 0.79** & 0.95** & 0.99** & -0.10 & 0.98** & 0.78** & 0.66* & -0.16 & 0.33 \\ \hline
 Churn bug  & 1** & 0.93** & 0.95** & 0.09 & 1** & -0.19 & 0.25 & 0.51 & -0.43 & 0.99** \\ \hline
...
\begin{table}[!htbp]
 ...
 \hline
& \bf{N} & \bf{Mean} & \bf{Median} & \bf{Std.Dev} & \bf{Max} & \bf{Min} \\ \hline
WIP  & 10 & -0.1 & -0.2 & 0.4 & 0.8 & -0.8\\ \hline
Throughput  & 10 & 0.3 & 0.3 & 0.5 & 0.9 & -0.5\\ \hline
Throughput ft  & 10 & 0.2 & 0.1 & 0.4 & 0.9 & -0.4\\ \hline
Throughput bug  & 10 & 0.3 & 0.2 & 0.4 & 0.9 & -0.2\\ \hline
Bugs  & 10 & 0.3 & 0.3 & 0.3 & 0.7 & -0.5\\ \hline
Bugs finished, quarter  & 10 & 0.6 & 0.6 & 0.3 & 0.9 & -0.2\\ \hline
Avg days backlog, bugs  & 10 & 0.1 & 0 & 0.5 & 0.9 & -0.6\\ \hline
Lead time & 10 & 0.4 & 0.3 & 0.4 & 1 & -0\\ \hline
Churn ft  & 10 & 0.5 & 0.7 & 0.5 & 1 & -0.4\\ \hline
Churn bug  & 10 & 0.5 & 0.7 & 0.5 & 1 & -0.4 \\ \hline
...
The result from when team size was taken into account is a linear value 0.2, whichs shows a weaker linear relationship than when team size was \textbf{not} taken into account. Three of the ten teams has a significant positive correlation. While the rest of teams correlation values varies from -0.28 to 0.32, as shown by Table \ref{DS:corr:WIP:v2}. 
...
When team size is taken into account, the correlation value is 0.2, as shown in Table \ref{DS:corr:WIP:v2}.  Nine out of ten teams have a positive correlation relationship, but only one team has a significant value as shown in Table \ref{corr:WIP:V2}. The values \textit{bug finished, quarter} and \textit{avg days backlog bugs}  has the correlation values 0.1 and 0. This shows that there is small or no linear relationship between \textit{WIP} and any of the \textit{bugs} variables, when team size is taken into account. 
...
The correlation between \textit{throughput} and \textit{WIP} when team size is not taken into account is a strong linear relationship, the correlation value when team size is taken into account represents a medium linear relationship. The strong relationship means when \textit{WIP} increases, \textit{throughput} increases. The medium relationship means that when \textit{WIP} increases, \textit{throughput} increase as well to an extent. The throughput descriptive statistic Tables \ref{DS:corr:TP:v2} and \ref{DS:corr:TP} shows that \textit{Bugs} has the overall correlation value of 0.6 and \textit{lead time} has the overall value of 0.5 with \textit{throughput}. One could see that if \textit{throughput} increases, so does both \textit{lead time} and \textit{bugs}. Both these values can't be used to see the impact of WIP-limits. These variables are isolated and can only be used to see what impact \textit{throughput} has on a software process.
...
\begin{subfigure}[b]{0.7\textwidth}
 ...
 \hline
  \textbf{Quarter} &	\textbf{N} &	\textbf{Mean} &	\textbf{Median} & \textbf{Std.Dev} & \textbf{Max}	& \textbf{Min} \\ \hline
 2010-3   & 92 & 0 &0 &0 &0 &0\\ \hline
 2010-4  & 144 & 1.6 & 0 &3 & 10 & 0\\ \hline
 2011-1  & 180 & 5.9 & 2.5 & 6.5 & 19 & 0\\ \hline
 2011-2  & 182 & 5.6 & 1.5 & 7.5 & 34 & 0\\ \hline
 2011-3  & 184 & 6.4 & 3 & 7 & 24 & 0\\ \hline
 2011-4  & 184 & 8 & 2.5 & 8.8 & 25 & 0\\ \hline
 2012-1  & 182 & 8.1 & 4 & 8.8 & 30 & 0\\ \hline
 2012-2  & 182 & 17.7 & 4 & 21.2 & 67 & 0\\ \hline
 2012-3  & 184 & 16.3 & 7.5 & 17.3 & 51 & 0\\ \hline
 2012-4  & 184 & 10.9 & 1.5 & 13.2 & 39 & 0\\ \hline
 2013-1  & 180 & 10.7 & 3.5 & 12.1 & 38 & 0\\ \hline
 2013-2  & 182 & 13.3 & 5.5 & 16.1 & 47 & 0\\ \hline
 2013-3  & 184 & 8 & 3 & 9.1 & 35 & 0\\ \hline
 2013-4  & 174 & 8.3 & 0 &9.2 & 29 & 0\\ \hline
 Total  & 2418 & 9.1 & 0 &12.5 & 67 & 0\\ \hline
\end{tabular}
}
\caption{DS - WIP}
 \label{DS:WIP:9}
