...
When team size is \textbf{not} taken into account, the overall correlation value is significant with a value of  0.41, shown in Table \ref{corr:All}.  The correlation Table \ref{corr:All:V2} shows the correlation values from when time size is taken into account. The table shows an overall significant correlation value of 0.29. The values from this section shows there is evidence that WIP-limit helps decrease bugs when \textit{team size} is taken into account, but without \textit{team size} taken into account, \textit{WIP} and \textit{bugs} has a positive significant correlation relationship.  
...
legge inn fra Tabell 24 her 23
