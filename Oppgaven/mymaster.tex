...
\subsection{Throughput and bugs correlation}
...
\end{tabular}
\caption{360 - Average churn for feature and bugs - Bugs }%
...
\end{table}
\newpage 
\subsection{Throughput and churn correlation}
Se på churn, churn feature churn bugs, average trenger  jeg vel ikke se på?
