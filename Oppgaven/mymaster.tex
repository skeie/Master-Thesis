...
As one can see, several people have their opinion on WIP and the importance of defining WIP limit. If  \L ukasz's effectiveness metric is disregard, there is no clear rule on how to determine WIP limit even though WIP is a crucial tool in order to use Kanban sufficient. 
