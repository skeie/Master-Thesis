...
\vspace{-1em}
To try to explain the positive correlation between \textit{WIP} and \textit{throughput} the mean WIP-limit for each of the teams were measured.  \textit{Team one} has an mean WIP-limit of 0.73. \textit{Team two} has an mean WIP-limit of 2.31. \textit{Team three} has an mean WIP-limit of 1.78. \textit{Team four} has an mean WIP-limit of 3.21. \textit{Team five} has an mean WIP-limit of 1.93. \textit{Team six} has an mean WIP-limit of 3.02. \textit{Team seven} has an mean WIP-limit of 2.03 .\textit{Team eight} has an mean WIP-limit of 0.71. \textit{Team nine} has an mean WIP-limit of 2.19 and \textit{team ten} has an mean WIP-limit of 1.08. This gives an mean WIP-limit of 1.9. 
\begin{figure}[H]
\begin{subfigure}[b]{.2\textwidth}
\center
 \scalebox{0.50}{
